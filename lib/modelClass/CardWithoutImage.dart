  ...
  return Container(
    ...
    child: Column(
      children: [
        ...
        //       elevation: 5.0,
        //       side: const BorderSide(width: 0.5, style: BorderStyle.solid),
        ...
        Row(
          ...
          children: [
            ...
            AppText(
                text:
                    "Products: ${double.parse(totalQuantity).toStringAsFixed(0)}",
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => ViewDetailsOrder(
                          orderData: orderData,
                        )));
              },
              child: Row(
